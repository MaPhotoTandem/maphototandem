...
export default function DownloadPending({ token }: { token: string }) {
  ...
  if (seconds >= MAX_WAIT) {
    return (
      <div className="max-w-xl mx-auto px-4 py-16 text-center">
        ...
        <h1 className="text-xl font-bold text-noir mb-2">La confirmation prend plus de temps que prévu</h1>
        ...
        <button
          ...
          className="bg-rouge text-white px-5 py-2.5 rounded-lg text-sm font-semibold hover:opacity-90 transition-opacity"
        >
          Réessayer
        </button>
      </div>
  ...
  return (
    <div className="max-w-xl mx-auto px-4 py-16 text-center">
      ...
      <h1 className="text-2xl font-bold text-noir mb-2">Paiement confirmé !</h1>
      <p className="text-gris-mid text-sm mb-6">Préparation de vos photos en cours...</p>

      {/* Spinner */}
      <div className="flex justify-center">
        <svg className="animate-spin w-6 h-6 text-rouge" fill="none" viewBox="0 0 24 24">
